...
### PCoA
Interestingly, seed mass did not predict a species' score for any PC axis except for axis 1 in the summer community (report p-values) . Erio aber [whatever that does].
